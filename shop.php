...
<head>
   <meta charset="UTF-8">
   <title>Book Nest | Shop by Genre</title>
...
<section class="products">
   ...
   ?>
      ...
      <h2 class="genre-title" style="margin-top: 30px; color: #333;"><?php echo htmlspecialchars($genre); ?></h2>

      <div class="box-container">
         <?php
         // Fetch products under this genre
